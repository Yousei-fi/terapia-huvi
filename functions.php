...
class TerapiaHuviTheme extends \Timber\Site {
    ...
    private function get_page_meta_definitions(): array {
        ...
        $urlHelp = __('Use a relative path (e.g. /osallistu) or a full URL.', 'terapia-huvi');
    ...
    private function get_default_content_map(): array {
        ...
        $this->defaultContentCache = [
            ...
            'frontpage-hero' => [
                'eyebrow_fi' => 'Ratkaisukeskeinen terapia',
                'eyebrow_en' => 'Solution-focused therapy',
                'title_fi' => 'Löydä vahvuutesi ja luo muutosta elämääsi',
                'title_en' => 'Discover your strengths and create change in your life',
                'content_fi' => '<p>Ratkaisukeskeinen terapia on lyhytkestoinen, tulevaisuuteen suuntautunut terapiamuoto, joka keskittyy asiakkaan vahvuuksiin ja resursseihin. Yhdessä tutkimme, mikä jo toimii elämässäsi ja miten voimme rakentaa siitä eteenpäin kohti toivottua muutosta.</p>',
                'content_en' => '<p>Solution-focused therapy is a brief, future-oriented approach that focuses on your strengths and resources. Together we explore what already works in your life and how we can build on that toward desired change.</p>',
                'cta_primary_label_fi' => 'Varaa aika',
                'cta_primary_label_en' => 'Book appointment',
                'cta_primary_url_fi' => '#',
                'cta_primary_url_en' => '#',
            ...
            'frontpage-contact' => [
                ...
                'copy_fi' => 'Ota rohkeasti yhteyttä, jos haluat keskustella terapiasta tai varata ajan. Voin auttaa monenlaisissa elämäntilanteissa ja haasteissa.',
                'copy_en' => 'Feel free to reach out if you want to discuss therapy or book an appointment. I can help with various life situations and challenges.',
                'general_contact_label_fi' => 'Sähköposti:',
                'general_contact_label_en' => 'Email:',
                'general_contact_email_fi' => 'terapia@esimerkki.fi',
                'general_contact_email_en' => 'therapy@example.com',
                'chair_label_fi' => 'Puhelin:',
                'chair_label_en' => 'Phone:',
                'chair_value_fi' => '+358 40 123 4567',
                'chair_value_en' => '+358 40 123 4567',
                'vice_chair_label_fi' => 'Vastaanotto:',
                'vice_chair_label_en' => 'Office:',
                'vice_chair_value_fi' => 'Ma-Pe 9-17',
                'vice_chair_value_en' => 'Mon-Fri 9-17',
                'board_members_label_fi' => 'Osoite:',
                'board_members_label_en' => 'Address:',
                'board_members_value_fi' => 'Esimerkkikatu 12, 00100 Helsinki',
                'board_members_value_en' => 'Example Street 12, 00100 Helsinki, Finland',
                'social_heading_fi' => 'Seuraa minua',
                'social_heading_en' => 'Follow me',
                ...
                'holvi_label_fi' => 'LinkedIn',
                'holvi_label_en' => 'LinkedIn',
            ],
            'site-navigation' => [
                'links_fi' => implode("\n", [
                    'Terapia::/terapia',
            ...
            'site-footer' => [
                'about_text_fi' => 'Tarjoan ratkaisukeskeistä terapiaa, joka keskittyy vahvuuksiin ja tulevaisuuteen. Autan löytämään tapoja edetä kohti parempaa hyvinvointia ja toivottua muutosta.',
                'about_text_en' => 'I offer solution-focused therapy that centers on strengths and the future. I help you find ways to move toward better wellbeing and desired change.',
                'contact_heading_fi' => 'Yhteystiedot',
                'contact_heading_en' => 'Contact',
                'contact_email_fi' => 'terapia@esimerkki.fi',
                'contact_email_en' => 'therapy@example.com',
                'contact_address_fi' => 'Esimerkkikatu 12, 00100 Helsinki',
                'contact_address_en' => 'Example Street 12, 00100 Helsinki, Finland',
                ...
                'link_2_label_fi' => 'Minusta',
                'link_2_label_en' => 'About me',
                'link_2_url_fi' => '/minusta',
                'link_2_url_en' => '/minusta?lang=en',
                'link_3_label_fi' => 'Yhteystiedot',
                'link_3_label_en' => 'Contact',
                'link_3_url_fi' => '/yhteystiedot',
                'link_3_url_en' => '/yhteystiedot?lang=en',
                'link_4_label_fi' => 'Tietosuoja',
                'link_4_label_en' => 'Privacy',
                'link_4_url_fi' => '/tietosuoja',
                'link_4_url_en' => '/tietosuoja?lang=en',
                'newsletter_heading_fi' => 'Ota yhteyttä',
                'newsletter_heading_en' => 'Get in touch',
                'newsletter_copy_fi' => 'Haluatko keskustella terapiasta tai varata ajan? Ota rohkeasti yhteyttä sähköpostitse tai puhelimitse.',
                'newsletter_copy_en' => 'Would you like to discuss therapy or book an appointment? Feel free to reach out by email or phone.',
                ...
                'newsletter_button_fi' => 'Lähetä viesti',
                'newsletter_button_en' => 'Send message',
                'social_facebook_label_fi' => 'Facebook',
                'social_facebook_label_en' => 'Facebook',
                'social_instagram_label_fi' => 'Instagram',
                'social_instagram_label_en' => 'Instagram',
            ...
            'terapia' => [
                'eyebrow_fi' => 'Ratkaisukeskeinen terapia',
                'eyebrow_en' => 'Solution-focused therapy',
                'title_fi' => 'Mikä on ratkaisukeskeinen terapia?',
                'title_en' => 'What is solution-focused therapy?',
                'content_fi' => '<p>Ratkaisukeskeinen terapia on lyhytkestoinen, tulevaisuuteen suuntautunut terapiamuoto, joka keskittyy asiakkaan vahvuuksiin ja resursseihin. Sen sijaan, että keskityttäisiin ongelmiin ja menneisyyteen, tutkimme yhdessä, mikä jo toimii elämässäsi ja miten voimme rakentaa siitä eteenpäin.</p>',
                'content_en' => '<p>Solution-focused therapy is a brief, future-oriented approach that focuses on your strengths and resources. Rather than focusing on problems and the past, we explore together what already works in your life and how we can build on that.</p>',
            ...
            'minusta' => [
                ...
                'title_fi' => 'Tervetuloa tutustumaan',
                'title_en' => 'Welcome to get to know me',
                'content_fi' => '<p>Olen koulutettu terapeutti, joka erikoistuu ratkaisukeskeiseen terapiaan. Autan ihmisiä löytämään vahvuuksiaan ja luomaan muutosta elämäänsä. Uskon, että jokaisella on resursseja ja kykyjä kehittää elämäänsä kohti parempaa hyvinvointia.</p>',
                'content_en' => '<p>I am a trained therapist specializing in solution-focused therapy. I help people discover their strengths and create change in their lives. I believe that everyone has the resources and abilities to develop their life toward better wellbeing.</p>',
                'highlights_fi' => implode("\n", [
                    'Koulutus::Olen suorittanut terapeutin koulutuksen ja erikoistunut ratkaisukeskeiseen terapiaan.',
                    'Kokemus::Työskentelen yksilö-, pari- ja perheterapian parissa.',
                    'Arvot::Uskon ihmisten vahvuuksiin ja kykyyn muuttaa elämäänsä.',
                ]),
                'highlights_en' => implode("\n", [
                    'Education::I have completed therapist training and specialized in solution-focused therapy.',
                    'Experience::I work with individual, couple, and family therapy.',
                    'Values::I believe in people\'s strengths and ability to change their lives.',
                ]),
            ],
            'yhteystiedot' => [
                'eyebrow_fi' => 'Yhteystiedot',
