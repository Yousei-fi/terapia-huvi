    ...
    private function get_default_content_map(): array {
        ...
        $this->defaultContentCache = [
            ...
            'minusta' => [
                ...
                'content_fi' => '<p>Olen ratkaisukeskeinen lyhytterapeutti ja kouluttaja. Työskentelen ihmisten kanssa, jotka haluavat löytää uusia näkökulmia, vahvistaa hyvinvointiaan ja löytää omat vastauksensa elämän kysymyksiin.</p><p>Uskon, että pienetkin muutokset voivat käynnistää suuria prosesseja. Terapiassa keskitymme siihen, mikä toimii – ei siihen, mikä on rikki.</p>',
                'content_en' => '<p>I am a solution-focused brief therapist and trainer. I work with people who want to find new perspectives, strengthen their wellbeing, and find their own answers to life\'s questions.</p><p>I believe that even small changes can trigger large processes. In therapy, we focus on what works – not on what is broken.</p>',
                'highlights_fi' => implode("\n", [
