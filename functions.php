...
class TerapiaHuviTheme extends \Timber\Site {
    ...
    private function get_content_page_definitions(): array {
        return [
            ['slug' => 'frontpage', 'title' => 'Frontpage Content', 'status' => 'draft'],
    ...
    private function get_page_meta_definitions(): array {
        ...
        $definitions['frontpage'] = [
            'title' => __('Frontpage Content', 'terapia-huvi'),
            'description' => __('All content sections for the homepage.', 'terapia-huvi'),
            'fields' => [
                // Overview section
                $this->make_field('overview_eyebrow_fi', __('Overview eyebrow (FI)', 'terapia-huvi')),
                $this->make_field('overview_eyebrow_en', __('Overview eyebrow (EN)', 'terapia-huvi')),
                $this->make_field('overview_title_fi', __('Overview heading (FI)', 'terapia-huvi')),
                $this->make_field('overview_title_en', __('Overview heading (EN)', 'terapia-huvi')),
                $this->make_field('overview_cards_fi', __('Overview cards (FI)', 'terapia-huvi'), 'textarea', ['rows' => 6, 'help' => $cardHelp]),
                $this->make_field('overview_cards_en', __('Overview cards (EN)', 'terapia-huvi'), 'textarea', ['rows' => 6, 'help' => $cardHelp]),
                // Contact section
                $this->make_field('contact_eyebrow_fi', __('Contact eyebrow (FI)', 'terapia-huvi')),
                $this->make_field('contact_eyebrow_en', __('Contact eyebrow (EN)', 'terapia-huvi')),
                $this->make_field('contact_title_fi', __('Contact heading (FI)', 'terapia-huvi')),
                $this->make_field('contact_title_en', __('Contact heading (EN)', 'terapia-huvi')),
                $this->make_field('contact_copy_fi', __('Contact intro text (FI)', 'terapia-huvi'), 'textarea', ['rows' => 5, 'help' => $richHelp]),
                $this->make_field('contact_copy_en', __('Contact intro text (EN)', 'terapia-huvi'), 'textarea', ['rows' => 5, 'help' => $richHelp]),
                $this->make_field('contact_general_label_fi', __('Contact general label (FI)', 'terapia-huvi')),
                $this->make_field('contact_general_label_en', __('Contact general label (EN)', 'terapia-huvi')),
                $this->make_field('contact_phone_label_fi', __('Contact phone label (FI)', 'terapia-huvi')),
                $this->make_field('contact_phone_label_en', __('Contact phone label (EN)', 'terapia-huvi')),
                $this->make_field('contact_address_label_fi', __('Contact address label (FI)', 'terapia-huvi')),
                $this->make_field('contact_address_label_en', __('Contact address label (EN)', 'terapia-huvi')),
                ...
                $this->make_field('testimonials_eyebrow_fi', __('Testimonials eyebrow (FI)', 'terapia-huvi')),
                $this->make_field('testimonials_eyebrow_en', __('Testimonials eyebrow (EN)', 'terapia-huvi')),
                $this->make_field('testimonials_title_fi', __('Testimonials heading (FI)', 'terapia-huvi')),
                $this->make_field('testimonials_title_en', __('Testimonials heading (EN)', 'terapia-huvi')),
                ...
                // Blog section
                $this->make_field('blog_eyebrow_fi', __('Blog eyebrow (FI)', 'terapia-huvi')),
                $this->make_field('blog_eyebrow_en', __('Blog eyebrow (EN)', 'terapia-huvi')),
                $this->make_field('blog_title_fi', __('Blog heading (FI)', 'terapia-huvi')),
                $this->make_field('blog_title_en', __('Blog heading (EN)', 'terapia-huvi')),
                $this->make_field('blog_content_fi', __('Blog intro text (FI)', 'terapia-huvi'), 'textarea', ['rows' => 5, 'help' => $richHelp]),
                $this->make_field('blog_content_en', __('Blog intro text (EN)', 'terapia-huvi'), 'textarea', ['rows' => 5, 'help' => $richHelp]),
                $this->make_field('blog_cta_label_fi', __('Blog CTA label (FI)', 'terapia-huvi')),
                $this->make_field('blog_cta_label_en', __('Blog CTA label (EN)', 'terapia-huvi')),
                $this->make_field('blog_cta_url_fi', __('Blog CTA URL (FI)', 'terapia-huvi'), 'text', ['help' => $urlHelp]),
                $this->make_field('blog_cta_url_en', __('Blog CTA URL (EN)', 'terapia-huvi'), 'text', ['help' => $urlHelp]),
                $this->make_field('blog_empty_message_fi', __('Blog empty message (FI)', 'terapia-huvi'), 'textarea', ['rows' => 3, 'help' => $richHelp]),
                $this->make_field('blog_empty_message_en', __('Blog empty message (EN)', 'terapia-huvi'), 'textarea', ['rows' => 3, 'help' => $richHelp]),
            ],
        ];
    ...
    private function get_default_content_map(): array {
        ...
        $this->defaultContentCache = [
            ...
            'frontpage' => [
                // Overview section
                'overview_eyebrow_fi' => 'Palvelut',
                'overview_eyebrow_en' => 'Services',
                'overview_title_fi' => 'Miten voin auttaa',
                'overview_title_en' => 'How I can help',
                'overview_cards_fi' => implode("\n", [
                    'Terapia::Ratkaisukeskeinen lyhytterapia auttaa sinua löytämään toivoa ja suuntaa elämään.::Lue lisää::/terapia',
                    'Hinnasto::Selkeät hinnat eri palveluille. Varaa aika vastaanotolleni.::Katso hinnasto::/hinnasto',
                    'Lahjakortit::Anna terapeuttinen lahjakortti läheisellesi.::Lue lisää::/lahjakortit',
                ]),
                'overview_cards_en' => implode("\n", [
                    'Therapy::Solution-focused brief therapy helps you find hope and direction in life.::Learn more::/terapia?lang=en',
                    'Pricing::Clear pricing for different services. Book an appointment at my office.::View pricing::/hinnasto?lang=en',
                    'Gift cards::Give a therapeutic gift card to someone close to you.::Learn more::/lahjakortit?lang=en',
                ]),
                // Contact section
                'contact_eyebrow_fi' => 'Yhteystiedot',
                'contact_eyebrow_en' => 'Contact',
                'contact_title_fi' => 'Ota yhteyttä',
                'contact_title_en' => 'Get in touch',
                'contact_copy_fi' => 'Ota rohkeasti yhteyttä, jos haluat keskustella terapiasta tai varata ajan.',
                'contact_copy_en' => 'Feel free to reach out if you want to discuss therapy or book an appointment.',
                'contact_general_label_fi' => 'Sähköposti:',
                'contact_general_label_en' => 'Email:',
                'contact_phone_label_fi' => 'Puhelin:',
                'contact_phone_label_en' => 'Phone:',
                'contact_address_label_fi' => 'Osoite:',
                'contact_address_label_en' => 'Address:',
                ...
                // Testimonials section
                'testimonials_eyebrow_fi' => 'Asiakkaiden palaute',
                'testimonials_eyebrow_en' => 'Client feedback',
                'testimonials_title_fi' => 'Mitä asiakkaat sanovat',
                ...
                // Blog section
                'blog_eyebrow_fi' => 'Blogi',
                'blog_eyebrow_en' => 'Blog',
                'blog_title_fi' => 'Blogi ja ajatuksia',
                'blog_title_en' => 'Blog and thoughts',
                'blog_content_fi' => '<p>Lue ajatuksiani terapiasta, hyvinvoinnista ja elämän haasteista.</p>',
                'blog_content_en' => '<p>Read my thoughts on therapy, wellbeing, and life challenges.</p>',
                'blog_cta_label_fi' => 'Kaikki artikkelit',
                'blog_cta_label_en' => 'All articles',
                'blog_cta_url_fi' => '/blogi',
                'blog_cta_url_en' => '/blogi?lang=en',
                'blog_empty_message_fi' => 'Artikkeleita on tulossa pian – seuraa minua somessa pysyäksesi ajan tasalla.',
                'blog_empty_message_en' => 'Articles coming soon—follow me on social media to stay in the loop.',
            ],
            'site-navigation' => [
                'links_fi' => implode("\n", [
                    'Etusivu::/',
